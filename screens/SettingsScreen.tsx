import { View, Text, Button, TextInput, TouchableOpacity, Modal, Image, Platform, ActivityIndicator, KeyboardAvoidingView, ScrollView, Alert } from 'react-native'
...
export default function SettingsScreen({ route, navigation }: { route: any, navigation: any }) {
    ...
    const { values, HandelDataChange } = useUserDataForm({
        name: user.name || "",
        birthday: user.birthdate || new Date(),
        bio: user.bio || "",
